<?php
/**
 * Custom functions to improve menus and make them compatible with the Twitter Bootstrap toolkit Dropdown menus in Wordpress. 
 *
 * @package Buddytastico
 * @since Buddytastico 1.0
 */
...
function themeideas_small_menu( $args ) {
	?>
		<li><a href="<?php echo home_url( '/' ); ?>"><?php _e( 'Home', 'themeideas' ); ?></a></li>
	<?php
}

/**
 * Class Name: Twitter_Bootstrap_Walker_Nav_Menu
 ...
 */
class Twitter_Bootstrap_Walker_Nav_Menu extends Walker_Nav_Menu {
